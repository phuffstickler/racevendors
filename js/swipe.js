...
Swipe.prototype = {
  ...
  slide: function(index, duration) {
   ...
   // var isLegacyAndroid = navigator.userAgent.search('Android') && browser.search('2.2') != -1;
    var isLegacyAndroid = navigator.userAgent.search('Android') && (browser.search('2.2') || browser.search('2.1')) != -1;

    //if(!isLegacyAndroid){style.MozTransform = style.webkitTransform = 'translate3d(' + -(index * this.width) + 'px,0,0)';}
    if(isLegacyAndroid){
